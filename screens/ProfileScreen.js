    ...
    return (
        <View>
            ...
            <View style={{ flexDirection: 'row', margin: 20 }}>
                ...
                />
                <View>
                    <Text style={{ color: 'black', fontWeight: 'bold', fontSize: 17, marginLeft: 10 }}>Cao Văn Hoàng</Text>
                    <Text style={{ color: 'gray', fontSize: 15, marginLeft: 10, marginTop: 10 }}>hoangcvph42448@fpt.edu.vn</Text>
                </View>
            </View>
